...
THREE.Vector3.prototype = {constructor: THREE.Vector3, set: function (a, b, c) {
    ...
    setLength: function (a) {
        ...
        var c = b ? b.x : 1, d = b ? b.y : 1, e = b ? b.z : 1, f = a.elements[0] / c, h = a.elements[4] / d, c = a.elements[1] / c, d = a.elements[5] / d, i = a.elements[9] / e, l = a.elements[10] / e;
...
THREE.Frustum.prototype.setFromMatrix = function (a) {
    ...
    b = d[1];
    var e = d[2], f = d[3], h = d[4], i = d[5], l = d[6], k = d[7], j = d[8], m = d[9], n = d[10], o = d[11], s = d[12], p = d[13], q = d[14], d = d[15];
...
THREE.Ray = function (a, b) {
    ...
    var f = new THREE.Vector3, h = new THREE.Vector3, i = new THREE.Vector3, l = new THREE.Vector3,
            k = new THREE.Vector3, j = new THREE.Vector3, m = new THREE.Vector3, n = new THREE.Vector3, o = new THREE.Vector3;
    this.intersectObject = function (a) {
        ...
        if (a instanceof THREE.Particle) {
            ...
            var p = c(this.origin, this.direction, a.matrixWorld.getPosition()), g = THREE.Frustum.__v1.set(a.matrixWorld.getColumnX().length(), a.matrixWorld.getColumnY().length(),
                    a.matrixWorld.getColumnZ().length());
            if (p > a.geometry.boundingSphere.radius * Math.max(g.x, Math.max(g.y, g.z)))
                return s;
                    ...
                    if (!(u < 0) && (a.doubleSided || (a.flipSided ?
                        ...
                        if (b instanceof THREE.Face3) {
                            ...
                            if (d(o, f, h, l) || d(o, h, i, l)) {
                                b = {distance: k.distanceTo(o), point: o.clone(),
                                    face: b, object: a};
                                s.push(b)
                            }
                        }
...
THREE.Matrix3.prototype = {constructor: THREE.Matrix3, getInverse: function (a) {
        var b = a.elements, a = b[10] * b[5] - b[6] * b[9], c = -b[10] * b[1] + b[2] * b[9], d = b[6] * b[1] - b[2] * b[5], e = -b[10] * b[4] + b[6] * b[8], f = b[10] * b[0] - b[2] * b[8], h = -b[6] * b[0] + b[2] * b[4], i = b[9] * b[4] - b[5] * b[8], l = -b[9] * b[0] + b[1] * b[8], k = b[5] * b[0] - b[1] * b[4], b = b[0] * a + b[1] * e + b[2] * i;
...
THREE.Matrix4.prototype = {constructor: THREE.Matrix4, set: function (a, b, c, d, e, f, h, i, l, k, j, m, n, o, s, p) {
        var q = this.elements;
        q[0] = a;
        q[4] = b;
        q[8] = c;
        ...
        var c = a.elements, d = b.elements, e = this.elements, f = c[0], h = c[4], i = c[8], l = c[12], k = c[1], j = c[5], m = c[9], n = c[13], o = c[2], s = c[6], p = c[10], q = c[14], w = c[3], A = c[7], y = c[11], c = c[15], u = d[0], H = d[4],
                B = d[8], K = d[12], N = d[1], Y = d[5], ca = d[9], I = d[13], ba = d[2], ja = d[6], ya = d[10], D = d[14], g = d[3], Na = d[7], za = d[11], d = d[15];
        ...
        var a = this.elements, b = a[0], c = a[4], d = a[8], e = a[12], f = a[1], h = a[5], i = a[9], l = a[13], k = a[2], j = a[6], m = a[10], n = a[14], o = a[3], s = a[7],
                p = a[11], a = a[15];
        ...
        var b = this.elements, c = a.elements, d = c[0], e = c[4], f = c[8], h = c[12], i = c[1], l = c[5], k = c[9], j = c[13], m = c[2], n = c[6], o = c[10], s =
        ...
        var c = this.elements, d = a.x, e = a.y, f = a.z, h = Math.cos(d), d = Math.sin(d), i = Math.cos(e), e = Math.sin(e), l = Math.cos(f), f = Math.sin(f);
        switch (b) {
            case "YXZ":
        ...
        var b = this.elements, c = a.x, d = a.y, e = a.z, f = a.w, h = c + c, i = d + d, l = e + e, a = c * h, k = c * i, c = c * l, j = d * i, d = d * l, e = e * l, h = f * h, i = f * i, f = f * l;
        b[0] = 1 - (j + e);
        b[4] = k - f;
        b[8] = c + i;
        b[1] = k + f;
        ...
        var b = this.elements, c = b[4], d = b[5], e = b[6], f = b[7], h = b[8], i = b[9], l = b[10], k = b[11], j = Math.cos(a), a = Math.sin(a);
        b[4] = j * c + a * h;
        b[5] = j * d + a * i;
        b[6] = j * e + a * l;
        b[7] = j * f + a * k;
        ...
        var b = this.elements, c = b[0], d = b[1], e = b[2], f = b[3], h = b[8], i = b[9], l = b[10], k = b[11], j = Math.cos(a), a = Math.sin(a);
        b[0] = j * c - a * h;
        b[1] = j * d - a * i;
        b[2] = j * e - a * l;
        b[3] = j * f - a * k;
        ...
        var b = this.elements, c = b[0], d = b[1], e = b[2], f = b[3], h = b[4], i = b[5], l = b[6], k = b[7], j = Math.cos(a), a = Math.sin(a);
        b[0] = j * c + a * h;
        b[1] = j * d + a * i;
        b[2] = j * e + a * l;
        b[3] = j * f + a * k;
        ...
        var d = a.x,
                e = a.y, f = a.z, h = Math.sqrt(d * d + e * e + f * f), d = d / h, e = e / h, f = f / h, h = d * d, i = e * e, l = f * f, k = Math.cos(b), j = Math.sin(b), m = 1 - k, n = d * e * m, o = d * f * m, m = e * f * m, d = d * j, s = e * j, j = f * j, f = h + (1 - h) * k, h = n + j, e = o - s, n = n - j, i = i + (1 - i) * k, j = m + d, o = o + s, m = m - d, l = l + (1 - l) * k, k = c[0], d = c[1], s = c[2], p = c[3], q = c[4], w = c[5], A = c[6], y = c[7], u = c[8], H = c[9], B = c[10], K = c[11];
        c[0] = f * k + h * q + e * u;
        c[1] = f * d + h * w + e * H;
        c[2] = f * s + h * A + e * B;
        c[3] = f * p + h * y + e * K;
...
THREE.Projector = function () {
    ...
    var d, e, f = [], h, i, l = [], k, j, m = [], n, o = [], s, p, q = [], w, A, y = [],
            u = {objects: [], sprites: [], lights: [], elements: []}, H = new THREE.Vector3, B = new THREE.Vector4, K = new THREE.Matrix4, N = new THREE.Matrix4, Y = new THREE.Frustum, ca = new THREE.Vector4, I = new THREE.Vector4;
        ...
        var h = function (a) {
            if (a.visible !== false) {
                if ((a instanceof THREE.Mesh || a instanceof THREE.Line) && (a.frustumCulled === false || Y.contains(a))) {
                    ...
                    a instanceof THREE.Light && u.lights.push(a);
        ...
        for (za = u.objects.length; d < za; d++) {
            ...
            if (O instanceof THREE.Mesh) {
                ...
                for (Da = La.length; R < Da; R++) {
                    ...
                    J = 0;
                    for (Z = Oa.length; J < Z; J++)
                        if (Ta = Oa[J][R]) {
                            Q = 0;
                            for (pa = Ta.length; Q < pa; Q++)
                                k.uvs[J][Q] = Ta[Q]
                        }
...
THREE.Quaternion.prototype = {constructor: THREE.Quaternion, set: function (a, b, c, d) {
        ...
        var b = Math.PI / 360, c = a.x * b, d = a.y * b, e = a.z * b, a = Math.cos(d), d = Math.sin(d), b = Math.cos(-e), e = Math.sin(-e), f = Math.cos(c), c = Math.sin(c), h = a * b, i = d * e;
        this.w = h * f - i * c;
        this.x = h * c + i * f;
        this.y = d * b * f + a * e * c;
        this.z = a * e * f - d * b * c;
        ...
        b || (b = a);
        var c = a.x, d = a.y, e = a.z, f = this.x, h = this.y, i = this.z, l = this.w, k = l * c + h * e - i * d, j = l * d + i * c - f * e, m = l * e + f * d - h * c, c = -f * c - h * d - i * e;
        b.x = k * l + c * -f + j * -i - m * -h;
        b.y = j * l + c * -h + m * -f - k * -i;
        b.z = m * l + c * -i + k * -h - j * -f;
        return b
...
THREE.Geometry.prototype = {constructor: THREE.Geometry, applyMatrix: function (a) {
        ...
        for (b = this.morphTargets.length; a < b; a++) {
            if (!this.morphNormals[a]) {
                ...
                for (d = this.faces.length; c < d; c++) {
                    e = this.faces[c];
                    l = new THREE.Vector3;
                    k = e instanceof THREE.Face3 ? {a: new THREE.Vector3, b: new THREE.Vector3, c: new THREE.Vector3} : {a: new THREE.Vector3, b: new THREE.Vector3, c: new THREE.Vector3, d: new THREE.Vector3};
                    h.push(l);
                    i.push(k)
                }
            }
        ...
        var b, c, d, e, f, h, i, l, k, j, m, n, o, s, p, q, w, A, y, u, H, B, K, N, Y = [], ca = [], I = new THREE.Vector3, ba = new THREE.Vector3, ja = new THREE.Vector3, ya = new THREE.Vector3, D = new THREE.Vector3;
        b = 0;
                ...
                for (a = 3; a > 0; a--)
                    if (d.indexOf(e["abcd"[a]]) != a) {
                        ...
                        for (d = this.faceVertexUvs.length; e <
                                d; e++)
                            (i = this.faceVertexUvs[e][f]) && i.splice(a, 1);
                        break
                    }
            }
        }
...
THREE.WebGLRenderer = function (a) {
    ...
    function f(a, b, c) {
        ...
        h = i.length;
        var k = a.colors, j = k.length, l = a.__vertexArray, n = a.__colorArray, o = a.__sortArray, m = a.verticesNeedUpdate, p = a.colorsNeedUpdate, s = a.__webglCustomAttributesList;
        if (c.sortParticles) {
            Ub.copy(qb);
    ...
    function o(a, b, c, d, e) {
        ...
        if (d.morphTargets && !e.__webglMorphTargetInfluences) {
            ...
            for (var f = 0, h = D.maxMorphTargets; f < h; f++)
            ...
            for (c = b.length; k < c; k++)
                if (l = f.uniforms[b[k][1]]) {
                    ...
                    switch (n) {
                        ...
                        case "v2v":
                            if (!i._array)
                                i._array = new Float32Array(2 * j.length);
                            n = 0;
                        ...
                        case "v3v":
                            if (!i._array)
                                i._array = new Float32Array(3 * j.length);
                            n = 0;
                            for (o = j.length; n < o; n++) {
                                q = n * 3;
                                i._array[q] = j[n].x;
                        ...
                        case "v4v":
                            if (!i._array)
                                i._array = new Float32Array(4 * j.length);
                            n = 0;
                            for (o = j.length; n < o; n++) {
                                q = n * 4;
                                i._array[q] = j[n].x;
                        ...
                        case "m4v":
                            ...
                            n = 0;
                            for (o = j.length; n < o; n++)
                                j[n].flattenToArrayOffset(i._array, n * 16);
                            g.uniformMatrix4fv(l, false, i._array);
                            break;
                        case "t":
                            g.uniform1i(l, j);
                            ...
                            if (l.image instanceof Array && l.image.length === 6) {
                                ...
                                if (i.image.length === 6)
                                    if (i.needsUpdate) {
                                        ...
                                        for (l = 0; l < 6; l++)
                                            g.texImage2D(g.TEXTURE_CUBE_MAP_POSITIVE_X + l, 0, o, o, q, j[l]);
                        ...
                        case "tv":
                            if (!i._array) {
                                i._array = [];
                                n = 0;
                                for (o = i.texture.length; n < o; n++)
                                    i._array[n] = j + n
                            }
                            g.uniform1iv(l, i._array);
                            n = 0;
                            for (o = i.texture.length; n < o; n++)
                                (l = i.texture[n]) && D.setTexture(l, i._array[n])
                        }
                }
            if ((d instanceof
    ...
    function A(a, b) {
        ...
        if (b.depthBuffer && !b.stencilBuffer) {
            ...
            g.renderbufferStorage(g.RENDERBUFFER, g.RGBA4, b.width, b.height)
    }
    function y(a) {
        switch (a) {
    ...
    var D = this, g, Na = [], za = null, Da = null, $ = -1, R = null, J = null, Z = 0, Q = -1, pa = -1, O = -1, sa = -1, Ga = -1, Ha = -1, La = -1, Oa = -1, Ta = null, Vb = null, Wb = null, Db = null, Eb = 0, Fb = 0, Xb = 0, Gb = 0, jc = 0, kc = 0, Yb = new THREE.Frustum, qb = new THREE.Matrix4, Ub = new THREE.Matrix4, Ra = new THREE.Vector4, Ca = new THREE.Vector3, rb = true, lc = {ambient: [0, 0, 0], directional: {length: 0, colors: [], positions: []},
        point: {length: 0, colors: [], positions: [], distances: []}, spot: {length: 0, colors: [], positions: [], distances: [], directions: [], angles: [], exponents: []}};
    g = function () {
        var a;
        try {
            if (!(a = H.getContext("experimental-webgl", {alpha: K, premultipliedAlpha: N, antialias: Y, stencil: ca, preserveDrawingBuffer: I})))
    ...
    this.clear = function (a, b, c) {
        var d = 0;
        if (a === void 0 || a)
            d = d | g.COLOR_BUFFER_BIT;
        if (b === void 0 || b)
            d = d | g.DEPTH_BUFFER_BIT;
        if (c === void 0 || c)
            d = d | g.STENCIL_BUFFER_BIT;
        g.clear(d)
    };
                ...
                for (var b in a.geometry.geometryGroups) {
                    ...
                    if (c.numMorphTargets) {
                        ...
                        for (e = c.numMorphTargets; d < e; d++)
                            g.deleteBuffer(c.__webglMorphTargetsBuffers[d])
                    }
                    if (c.numMorphNormals) {
                        d = 0;
                        for (e = c.numMorphNormals; d < e; d++)
                            g.deleteBuffer(c.__webglMorphNormalsBuffers[d])
                    }
                    if (c.__webglCustomAttributesList) {
                        d = void 0;
                        for (d in c.__webglCustomAttributesList)
                            g.deleteBuffer(c.__webglCustomAttributesList[d].buffer)
                    }
    ...
    this.renderBufferImmediate = function (a, b, c) {
        ...
        if (!a.__webglNormalBuffer)
            a.__webglNormalBuffer = g.createBuffer();
        if (a.hasPos) {
            g.bindBuffer(g.ARRAY_BUFFER, a.__webglVertexBuffer);
                    ...
                    if (b) {
                        ...
                        if (a.uv >= 0 && e.vertexUvBuffer)
                            if (e.vertexUvBuffer) {
                                ...
                                g.disableVertexAttribArray(a.uv);
    ...
    this.renderBuffer = function (a, b, c, d, e, f) {
        if (d.visible !== false) {
            var h, i, c = o(a, b, c, d, f), b = c.attributes, a = false, c = e.id * 16777215 + c.id * 2 + (d.wireframe ? 1 : 0);
            if (c !== R) {
                R = c;
                a = true
            }
            ...
            if (a) {
                ...
                if (b.uv >= 0)
                    if (e.__webglUVBuffer) {
                        ...
                        g.disableVertexAttribArray(b.uv);
                if (b.uv2 >= 0)
                    if (e.__webglUV2Buffer) {
                        ...
                        g.disableVertexAttribArray(b.uv2);
    ...
    this.initWebGLObjects = function (a) {
                ...
                if (h instanceof THREE.Mesh) {
                    ...
                    if (l instanceof THREE.Geometry) {
                        if (l.geometryGroups === void 0) {
                            var q = l, p = void 0, s = void 0, u = void 0, w = void 0, y = void 0, A = void 0, B = void 0, H = {}, K = q.morphTargets.length, Y = q.morphNormals.length;
                            q.geometryGroups = {};
                            p = 0;
                            for (s = q.faces.length; p < s; p++) {
                                ...
                                q.geometryGroups[B] === void 0 && (q.geometryGroups[B] = {faces3: [], faces4: [], materialIndex: w, vertices: 0, numMorphTargets: K, numMorphNormals: Y});
                        ...
                        for (k in l.geometryGroups) {
                            ...
                            if (!o.__webglVertexBuffer) {
                                ...
                                if (N.numMorphTargets) {
                                    ...
                                    O = 0;
                                    for (R = N.numMorphTargets; O < R; O++)
                                        N.__webglMorphTargetsBuffers.push(g.createBuffer())
                                }
                                if (N.numMorphNormals) {
                                    N.__webglMorphNormalsBuffers = [];
                                    O = 0;
                                    for (R = N.numMorphNormals; O < R; O++)
                                        N.__webglMorphNormalsBuffers.push(g.createBuffer())
                                }
                                D.info.memory.geometries++;
                                var I = o, ba = h, ja = ba.geometry, ca = I.faces3, $ = I.faces4, Q = ca.length * 3 + $.length * 4, za = ca.length * 1 + $.length * 2, pa = ca.length * 3 + $.length * 4, ya = c(ba, I), Na = e(ya), la = d(ya), Da = ya.vertexColors ? ya.vertexColors : false;
                                I.__vertexArray = new Float32Array(Q * 3);
                                if (la)
                                    I.__normalArray = new Float32Array(Q * 3);
                                if (ja.hasTangents)
                                    I.__tangentArray = new Float32Array(Q * 4);
                                if (Da)
                                    I.__colorArray = new Float32Array(Q * 3);
                                if (Na) {
                                    if (ja.faceUvs.length > 0 || ja.faceVertexUvs.length > 0)
                                        I.__uvArray = new Float32Array(Q * 2);
                                    if (ja.faceUvs.length > 1 || ja.faceVertexUvs.length >
                                            1)
                                        I.__uv2Array = new Float32Array(Q * 2)
                                }
                                ...
                                if (I.numMorphTargets) {
                                    ...
                                    sa = 0;
                                    for (Ca = I.numMorphTargets; sa < Ca; sa++)
                                        I.__morphTargetsArrays.push(new Float32Array(Q *
                                                3))
                                }
                                if (I.numMorphNormals) {
                                    I.__morphNormalsArrays = [];
                                    sa = 0;
                                    for (Ca = I.numMorphNormals; sa < Ca; sa++)
                                        I.__morphNormalsArrays.push(new Float32Array(Q * 3))
                                }
        ...
        for (; a.__objectsRemoved.length; ) {
            ...
            if (mc instanceof THREE.Mesh || mc instanceof THREE.Line)
                for (var Fb = a.__webglObjects, Xb = mc, nc = Fb.length - 1; nc >= 0; nc--)
                    Fb[nc].object === Xb && Fb.splice(nc, 1);
        ...
        for (var Gb = 0, Yb = a.__webglObjects.length; Gb < Yb; Gb++) {
            ...
            if (Va instanceof THREE.Mesh)
                        ...
                        if (V.verticesNeedUpdate || V.morphTargetsNeedUpdate || V.elementsNeedUpdate || V.uvsNeedUpdate || V.normalsNeedUpdate || V.colorsNeedUpdate || V.tangetsNeedUpdate || Nb) {
                            ...
                            if (M.__inittedArrays) {
                                var Vb = d(Hb), Ac = Hb.vertexColors ? Hb.vertexColors :
                                        ...
                                        Jc = Ba.uvsNeedUpdate, Nc = Ba.normalsNeedUpdate, Oc = Ba.tangetsNeedUpdate, Pc = Ba.colorsNeedUpdate, Qc = Ba.morphTargetsNeedUpdate, Ib = Ba.vertices, T = M.faces3, U = M.faces4, na = Ba.faces, Ec = Ba.faceVertexUvs[0], Fc = Ba.faceVertexUvs[1], Jb = Ba.skinVerticesA, Kb = Ba.skinVerticesB, Lb = Ba.skinIndices, Bb = Ba.skinWeights, Cb = Ba.morphTargets, sc = Ba.morphNormals;
                                        ...
                                        for (C = U.length; v < C; v++) {
                                            ...
                                            if (Hb.morphNormals) {
                                                if (oc) {
                                                    ...
                                                    bc = ab = $a = Za = sc[ta].faceNormals[Ab];
                                                ra = Cc[ta];
                                                ra[L] = Za.x;
                                                ra[L + 1] = Za.y;
                                                ra[L + 2] = Za.z;
                ...
                if (V.verticesNeedUpdate || V.colorsNeedUpdate || Nb) {
                    var pb = V, Gc = g.DYNAMIC_DRAW, hc = void 0, ic = void 0, tc = void 0, ia = void 0, uc = void 0, Kc = pb.vertices, Lc = pb.colors, Rc = Kc.length, Sc = Lc.length, vc = pb.__vertexArray, wc = pb.__colorArray, Tc = pb.colorsNeedUpdate, Hc = pb.__webglCustomAttributesList, xc = void 0, Mc = void 0, wa = void 0, Tb = void 0, Fa = void 0, aa = void 0;
    ...
    this.initMaterial = function (a, b, c, d) {
        ...
        a:{
            m = a.fragmentShader;
            k = a.vertexShader;
            var i = a.uniforms, b = a.attributes, c = {map: !!a.map, envMap: !!a.envMap, lightMap: !!a.lightMap, vertexColors: a.vertexColors, fog: c, useFog: a.fog, sizeAttenuation: a.sizeAttenuation, skinning: a.skinning, maxBones: 50, morphTargets: a.morphTargets, morphNormals: a.morphNormals,
                maxMorphTargets: this.maxMorphTargets, maxMorphNormals: this.maxMorphNormals, maxDirLights: j, maxPointLights: l, maxSpotLights: n, maxShadows: o, shadowMapEnabled: this.shadowMapEnabled && d.receiveShadow, shadowMapSoft: this.shadowMapSoft, shadowMapDebug: this.shadowMapDebug, shadowMapCascade: this.shadowMapCascade, alphaTest: a.alphaTest, metal: a.metal, perPixel: a.perPixel, wrapAround: a.wrapAround, doubleSided: d && d.doubleSided}, s, d = [];
            if (h)
                d.push(h);
            else {
                d.push(m);
            ...
            for (u = 0; u < c.maxMorphTargets; u++)
                d.push("morphTarget" + u);
            for (u = 0; u < c.maxMorphNormals; u++)
                d.push("morphNormal" + u);
            for (p in b)
                d.push(p);
            p = d;
            u = 0;
        ...
        if (a.attributes)
            for (f in a.attributes)
                p[f] !== void 0 && p[f] >= 0 && g.enableVertexAttribArray(p[f]);
        if (a.morphTargets) {
    ...
    this.setTexture = function (a, b) {
        if (a.needsUpdate) {
            ...
            g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,
                    a.premultiplyAlpha);
            var c = a.image, d = (c.width & c.width - 1) === 0 && (c.height & c.height - 1) === 0, e = u(a.format), f = u(a.type);
            w(g.TEXTURE_2D, a, d);
    ...
    this.setRenderTarget = function (a) {
        ...
        if (a && !a.__webglFramebuffer) {
            ...
            a.__webglTexture = g.createTexture();
            var c = (a.width & a.width - 1) === 0 && (a.height & a.height - 1) === 0, d = u(a.format), e = u(a.type);
            if (b) {
...
THREE.GeometryUtils = {merge: function (a, b) {
        for (var c, d, e = a.vertices.length, f = b instanceof THREE.Mesh ? b.geometry : b, h = a.vertices, i = f.vertices, l = a.faces, k = f.faces, j = a.faceVertexUvs[0], m = f.faceVertexUvs[0], n = {}, o = 0; o < a.materials.length; o++)
            n[a.materials[o].id] = o;
        ...
        for (s = m.length; o < s; o++) {
            ...
            for (p = c.length; i < p; i++)
                d.push(new THREE.UV(c[i].u, c[i].v));
            j.push(d)
        }
    }, clone: function (a) {
        ...
        for (c = f.length; a < c; a++) {
            for (var d = f[a], e = [], h = 0, i = d.length; h < i; h++)
                e.push(new THREE.UV(d[h].u, d[h].v));
        ...
        for (c = a.faces.length; b < c; b++) {
            ...
            if (d instanceof THREE.Face4) {
                ...
                d = 0;
                for (e = a.faceUvs.length; d < e; d++)
                    h[d].push(a.faceUvs[d]);
                d = 0;
                for (e = a.faceVertexUvs.length; d <
                        e; d++)
                    i[d].push(a.faceVertexUvs[d])
            }
        }
        a.faces = f;
        a.faceUvs = h;
        ...
        for (var b = [], c = 0, d = a.faces.length; c < d; c++) {
            ...
            if (f instanceof THREE.Face4) {
                var h = f.a, i = f.b, l = f.c, h = a.vertices[h], i = a.vertices[i], l = a.vertices[l], k = a.vertices[f.d];
                b.push(h.clone());
                b.push(i.clone());
                b.push(l.clone());
                b.push(k.clone());
...
THREE.ImageUtils = {crossOrigin: "anonymous", loadTexture: function (a, b, c) {
        ...
        h.drawImage(a, 0, 0);
        for (var i = h.getImageData(0, 0, d, e).data, l = h.createImageData(d, e), k = l.data, j = 0; j < d; j++)
            for (var m = 0; m < e; m++) {
                var n = m - 1 < 0 ? 0 : m - 1, o = m + 1 > e - 1 ? e - 1 : m + 1, s = j - 1 < 0 ? 0 : j - 1, p = j + 1 > d - 1 ? d - 1 : j + 1, q = [], w = [0, 0, i[(m * d + j) * 4] / 255 * b];
                ...
                s = q.length;
                for (o = 0; o < s; o++) {
                    var p = q[o], A = q[(o + 1) % s], p = [p[0] - w[0], p[1] - w[1], p[2] - w[2]], A = [A[0] - w[0], A[1] - w[1], A[2] - w[2]];
...
THREE.CubeGeometry = function (a, b, c, d, e, f, h, i) {
    ...
    if (i != void 0)
        for (var y in i)
            this.sides[y] !== void 0 && (this.sides[y] = i[y]);
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
    THREE.Geometry.call(this);
    var a = a !== void 0 ? a : 20, b = b !== void 0 ? b : 20, c = c !== void 0 ? c : 100, h = c / 2, d = d || 8, e = e || 1, i, l, k = [], j = [];
    for (l = 0; l <= e; l++) {
    ...
    for (i = 0; i < d; i++) {
        ...
        for (l = 0; l < e; l++) {
            var o = k[l][i], s = k[l + 1][i], p = k[l + 1][i + 1], q = k[l][i + 1], w = m.clone(), A = m.clone(), y = n.clone(), u = n.clone(), H = j[l][i].clone(), B = j[l + 1][i].clone(), K = j[l + 1][i + 1].clone(), N = j[l][i + 1].clone();
...
THREE.PlaneGeometry = function (a, b, c, d) {
    THREE.Geometry.call(this);
    for (var e = a / 2, f = b / 2, c = c || 1, d = d || 1, h = c + 1, i = d + 1, l = a / c, k = b / d, j = new THREE.Vector3(0, 1, 0), a = 0; a < i; a++)
        for (b = 0; b < h; b++)
            this.vertices.push(new THREE.Vector3(b * l - e, 0, a * k - f));
    for (a = 0; a < d; a++)
        for (b = 0; b < c; b++) {
...
THREE.SphereGeometry = function (a, b, c, d, e, f, h) {
    THREE.Geometry.call(this);
    var a = a || 50, d = d !== void 0 ? d : 0, e = e !== void 0 ? e : Math.PI * 2, f = f !== void 0 ? f : 0, h = h !== void 0 ? h : Math.PI, b = Math.max(3, Math.floor(b) || 8), c = Math.max(2, Math.floor(c) || 6), i, l, k = [], j = [];
    for (l = 0; l <= c; l++) {
        var m = [], n = [];
        for (i = 0; i <= b; i++) {
    ...
    for (l = 0; l < c; l++)
        for (i = 0; i < b; i++) {
            var d = k[l][i + 1], e = k[l][i], f = k[l + 1][i], h = k[l + 1][i + 1], m = this.vertices[d].clone().normalize(), n = this.vertices[e].clone().normalize(), o = this.vertices[f].clone().normalize(), s = this.vertices[h].clone().normalize(), p = j[l][i + 1].clone(), q = j[l][i].clone(), w = j[l + 1][i].clone(), A = j[l + 1][i + 1].clone();
...
THREE.PolyhedronGeometry = function (a, b, c, d) {
    ...
    THREE.Geometry.call(this);
    for (var c = c || 1, d = d || 0, l = this, k = 0, j = a.length; k < j; k++)
        e(new THREE.Vector3(a[k][0], a[k][1], a[k][2]));
    for (var m = [], a = this.vertices, k = 0, j = b.length; k < j; k++)
        f(a[b[k][0]], a[b[k][1]], a[b[k][2]], d);
    this.mergeVertices();
    k = 0;
    for (j = this.vertices.length; k < j; k++)
